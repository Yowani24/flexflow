...
export default function Header() {
  return (
    <div className="h-30 bg-white fixed top-0 left-0 w-full z-10 flex flex-col items-center justify-between">
      <div className="h-16 bg-white w-full z-10 flex items-center justify-between px-10">
        ...
        <Menu>
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-500 text-sm hidden md:flex">
      ...
      <div className="w-full h-10 hidden z-50">ghyjukl</div>
    </div>
  );
}
